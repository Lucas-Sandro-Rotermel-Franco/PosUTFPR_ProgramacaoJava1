...
public class Application {
    ...
    public static final String SELLER = "Rosângela Almeida";
    ...
    private void startReading() {
        ...
        System.out.printf("A vendedora %s totalizou %s em vendas%n", SELLER, totalSalesBySeller);
        ...
        final var totalSalesByStatusAndMonth = reader.totalSalesByStatusAndMonth(Sale.Status.COMPLETED, Month.JANUARY, Month.JUNE, Month.DECEMBER);
        ...
        System.out.println("-------------------");
        Map<Integer, BigDecimal> totalSalesByYear = reader.totalSalesByYear();

        totalSalesByYear.forEach((year, total) ->
                System.out.printf("Ano: %d | Total vendido: R$ %.2f%n", year, total));
        ...
        Optional<String> managerOpt = reader.getManagerWithMostCancellationsBetween2013And2014();

        managerOpt.ifPresentOrElse(
                manager -> System.out.println("Gerente com mais cancelamentos entre 2013 e 2014: " + manager),
                () -> System.out.println("Nenhum cancelamento encontrado no período.")
        );

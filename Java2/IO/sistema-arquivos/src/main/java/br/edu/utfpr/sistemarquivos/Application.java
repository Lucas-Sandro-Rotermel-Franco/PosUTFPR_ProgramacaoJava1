...
public class Application {
    ...
    public static final String ROOT = File.separator + "home" + File.separator + "lucassandro" + File.separator + "PosUTFPR" + File.separator + "PosUTFPR_ProgramacaoJava1" + File.separator + "Java2" + File.separator + "IO" + File.separator + "hd" + File.separator;
